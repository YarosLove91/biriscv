...
Исходный код представлен в [makefile](/tb/tb_top/makefile)
...
| `SYSTEMC_HOME`      | Путь к установке SystemC                    | `/usr/local/systemc-3.0.1`                                |
...
| Цель        | Описание                                                                   |
|-------------|----------------------------------------------------------------------------|
| `build`     | Вызывает генерацию кода, затем сборку кода, а потом запуск testbench       |
| `all`       | Псевдоним для `build`                                                      |
...
Описание cpp файлов представлено в файле [tb_top_cpp.md](/tb_description/tb_top_cpp.md)

# Описание заголовочных файлов

Описание заголовочных файлов представлено в файле [tb_top_headers.md](/tb_description/tb_top_headers.md)
